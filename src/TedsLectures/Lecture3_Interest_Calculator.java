...
public class Lecture3_Interest_Calculator {
    /**
    ...
    public static void main(String[] args){
        ...
        String balanceInput = sc.nextLine();//Why not to assign type double here to safe converting?
        ...
        String interestInput = sc.nextLine(); // What is the reason for creating a String variable and then converting it into double? Why not to create doube?
